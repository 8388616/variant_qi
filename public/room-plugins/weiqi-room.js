...
window.RoomPlugins['weiqi'] = {
    shell: {
        "title": "围棋",
        "rulesHtml": "基本规则同围棋。<br />",
        "defaultKomiText": "黑贴白3.25点",
        "boardSizeMin": 7,
        "boardSizeMax": 99,
        "defaultBoardSize": 19,
        "minLib": 1,
        "recordDownloadPrefix": "围棋",
    ...
    mount: function (ctx) {
        ...
        var recordDownloadPrefix = config.recordDownloadPrefix != null ? config.recordDownloadPrefix : "围棋";
...
const BOARD_MARK_CHAR_LIST = (() => {
        ...
        // 标准围棋：形势判断/数点接入 Benson 无条件活（仅本棋种；其它围棋走公共默认实现）
