...
window.RoomPlugins['quadriliberty-weiqi'] = {
    ...
    mount: function (ctx) {
        ...
        var recordDownloadPrefix = config.recordDownloadPrefix != null ? config.recordDownloadPrefix : "四气围棋";
        var minLib = config.minLib != null ? config.minLib : 4;
