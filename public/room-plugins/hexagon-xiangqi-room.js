...
return {
    ...
    generateBoardPayload
        ...
        function drawBoard() {
            ...
            // 木质外框与 weiqi 统一：无阴影、底色改填公共木纹图案（本棋种是透明画布棋种，
            // CSS 木纹会被跳过，见 room.js WOOD_TEXTURE_GAMES）、边线 #3a281c 0.5px
            ctx2d.shadowBlur = 0;
            ctx2d.shadowOffsetY = 0;
            ctx2d.fillStyle = QiSquareWeiqiCanvas.getWoodFill(ctx2d, canvas) || '#fdcc90';
