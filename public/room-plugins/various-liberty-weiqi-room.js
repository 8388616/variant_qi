...
window.RoomPlugins['various-liberty-weiqi'] = {
    shell: {
        "title": "异气围棋",
        "rulesHtml": "基本规则同围棋。<br /><br />棋子有一气、二气、三气、四气四种，最小气数分别为1、2、3、4。每片棋至少要有n口气才能留在棋盘上，其中n为这片棋中所有棋子的最小气数平均值。<br /><br />双方各有容量为8的背包。开局时背包里有每种其中各2枚。每手棋可以从背包中选一枚棋子落子。<br /><br />每手棋结束后，若背包未满，则会依次补充一枚一气、二气、三气、四气棋子。<br />",
