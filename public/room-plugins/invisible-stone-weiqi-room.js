...
const scoreTitle = document.getElementById('scoreTitle');
        ...
        function rebuildLiveReplayFromReplaySync(replaySync) {
            ...
            ps.liveReplayTruthBoard = page.deepCopyBoard(curBoard);
        ...
        function applyLiveReplayIncremental(replaySync) {
            ...
            const size = ps.BOARD_SIZE;
            const pwsh = replaySync.plainWeiqiStartHand != null ? replaySync.plainWeiqiStartHand : null;
            let curBoard = ps.liveReplayTruthBoard
                ? page.deepCopyBoard(ps.liveReplayTruthBoard)
                : page.initBoardArray(size);
            ...
            function pushStep(lastMarkersRaw) {
                ...
                ps.liveReplayMarkers.push(filterLiveLastMoveMarkers(lastMarkersRaw, curInv, slot).map(m => ({ ...m })));
