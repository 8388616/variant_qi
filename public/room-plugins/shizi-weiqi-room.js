...
window.RoomPlugins['shizi-weiqi'] = {
    shell: {
        "title": "十子围棋",
        "rulesHtml": "基本规则同围棋。<br /><br />某一方在横、竖或斜线上连成十子时立即获胜；否则数点判定胜负。<br /><br />",
        "defaultKomiText": "黑贴白3.25点",
        "boardSizeMin": 7,
        "boardSizeMax": 99,
        "defaultBoardSize": 19,
        "minLib": 1,
        "recordDownloadPrefix": "十子围棋",
    ...
    mount: function (ctx) {
        ...
        var recordDownloadPrefix = config.recordDownloadPrefix != null ? config.recordDownloadPrefix : "十子围棋";
