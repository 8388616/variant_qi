...
window.RoomPlugins["reverse-wuziqi"] = {
    shell: {
        "title": "反五子棋",
        "rulesHtml": "基本规则同五子棋。<br /><br />不允许虚着。<br /><br />先成五的一方落败。",
        "defaultKomiText": "无禁手",
        "boardSizeMin": 7,
        "boardSizeMax": 15,
        "defaultBoardSize": 13,
        "minLib": 1,
        "recordDownloadPrefix": "反五子棋",
    ...
    mount: function (ctx) {
        ...
        var recordDownloadPrefix = config.recordDownloadPrefix != null ? config.recordDownloadPrefix : "反五子棋";
        ...
        page = QiWeiqiSquarePageRuntime.create(ps, domPage, {
            ...
            enterReplayMode(data) {
                ...
                const snaps = QiWeiqiSquarePageRuntime.buildWuziqiReplaySnapshotsFromMoves(
                    data.moves, bs, true, () => page.initBoardArray(bs), QiSquareWeiqiCanvas.deepCopyBoard
                );
