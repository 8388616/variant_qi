...
const { qiBoardSeatOverlay, QiTwoPlayerRoomBase, qiProtocol, qiMatchTimeControl, squareWeiqiRules, applyInitialPositionCompact, encodeInitialPositionCompact } = require('../common');
...
function encodeMoveToRecordString(m) {
    const prefix = m.player === 'player1' ? 'B' : 'W';
...
class SudokuWeiqiRoom extends QiTwoPlayerRoomBase {
    ...
    _bagOf(slot) {
        return slot === 'player1' ? this.blackBagAvail : this.whiteBagAvail;
    }
