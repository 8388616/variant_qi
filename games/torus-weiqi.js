...
const { QiTwoPlayerRoomBase, qiProtocol, qiMatchTimeControl, applyInitialPositionCompact, encodeInitialPositionCompact, encodeOpeningPositionCompact } = require('../common');
