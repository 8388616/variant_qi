...
void NeuralNet::getOutput(
  ...
  for(int nIdx = 0; nIdx < batchSize; nIdx++) {
    ...
    SymmetryHelpers::copyInputsWithSymmetry(
      rowSpatial, rowSpatialInput, 1, nnYLen, nnXLen, numSpatialFeatures, false, inputBufs[nIdx]->symmetry, inputBufs[nIdx]->isSnubQuadrangleForServer,
  ...
  for(int row = 0; row < batchSize; row++) {
    ...
    if(numPolicyChannels == 2 || (numPolicyChannels == 4 && modelVersion >= 16)) {
      ...
      SymmetryHelpers::copyOutputsWithSymmetry(
        policyProbsTmp, policyProbs, 1, nnYLen, nnXLen, inputBufs[row]->symmetry, inputBufs[row]->isSnubQuadrangleForServer,
    ...
    if(output->whiteOwnerMap != NULL) {
      ...
      SymmetryHelpers::copyOutputsWithSymmetry(
        ownershipSrcBuf, output->whiteOwnerMap, 1, nnYLen, nnXLen, inputBufs[row]->symmetry, inputBufs[row]->isSnubQuadrangleForServer,
        inputBufs[row]->isSnubQuadrangleForServer ? inputBufs[row]->boardXSizeForServer : 0);
    }
