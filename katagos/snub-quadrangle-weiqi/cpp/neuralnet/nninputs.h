...
namespace SymmetryHelpers {
  ...
  //When isSnubQuadrangle, uses column/row playable-vertex reversal (see SnubQuadrangle::applySymmetryRC).
  //snubGridLen: actual board side (e.g. 10); tensor may be larger (e.g. 19). 0 = use hSize.
  void copyInputsWithSymmetry(const float* src, float* dst, int nSize, int hSize, int wSize, int cSize, bool useNHWC, int symmetry, bool isSnubQuadrangle = false, int snubGridLen = 0);
  void copyOutputsWithSymmetry(const float* src, float* dst, int nSize, int hSize, int wSize, int symmetry, bool isSnubQuadrangle = false, int snubGridLen = 0);
  ...
  Loc getSymLoc(int x, int y, int xSize, int ySize, int symmetry, bool isSnubQuadrangle = false);
  Loc getSymLoc(Loc loc, int xSize, int ySize, int symmetry, bool isSnubQuadrangle = false);
