const { QiTwoPlayerRoomBase, qiMatchTimeControl, squareWeiqiRules, applyInitialPositionCompact } = require('../common');
        ...
        switch (msg.type) {
            ...
            case 'move':
                ...
                if (!slot || !this._timeAllowsPlay(slot))
                    return;
                if (slot !== (this.currentPlayer === 1 ? 'black' : 'white')) return;
